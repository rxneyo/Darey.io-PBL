...
```
![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/b64380d3-4afd-470b-813d-0f0e7c78891a)


Make sure that wireshark is deleted on all the servers by running `wireshark --version`

![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/0c43621c-5aa0-4831-921b-2defb51ade20)
...
1. Launch 2 fresh EC2 instances using RHEL 8 image, we will use them as our `uat` servers, so give them names accordingly – Web1-UAT and Web2-UAT.
   ...
   **Tip**: Do not forget to stop EC2 instances that you are not using at the moment to avoid paying extra. For now, you only need 2 new RHEL 8 servers as Web Servers and 1 existing Jenkins-Ansible server up and running.
   ...
   ![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/3b567c7a-e2aa-49cd-b076-e959cbe416e8)
...
![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/4ca3020a-de33-4956-9e24-b7549fccfafa)
...
[For Windows users] – (https://www.youtube.com/watch?v=OplGrY74qog&feature=youtu.be)
...
a. Install and configure Apache (`httpd` service)

b. Clone **Tooling website** from GitHub `https://github.com/<your-name>/tooling.git`.

c. Ensure the tooling website code is deployed to `/var/www/html` on each of 2 UAT Web servers.

d. Make sure httpd service is started
...
Commit your changes, create a Pull Request and merge them to `master` or `main` branch, make sure webhook triggered two consequent Jenkins jobs, they ran successfully and copied all the files to your `Jenkins-Ansible` server into `/home/ubuntu/ansible-config-mgt/` directory.
...
![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/28aecb2c-bcdf-401c-bac0-244b75f69357)




![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/fe13cf30-ea3c-45fb-a280-eae43b07d988)
...
![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/02b03667-cc52-4c78-bef0-b097cab35278)
...
![image](https://github.com/rxneyo/DevOps_Projects/assets/125794122/bb3d15d6-db59-466d-9b76-1dc506d221b6)
